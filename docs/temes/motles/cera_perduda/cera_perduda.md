...
Aquest procés, també anomenat fosa en motlle de sorra, consisteix a abocar metall fos dins d'un motlle de sorra i deixar-lo solidificar; posteriorment es trenca el motlle per extraure la peça. Un cop fosa, la peça cal netejar-la i inspeccionar-la, i de vegades sotmetre-la a un tractament tèrmic per millorar-ne les propietats metal·lúrgiques. La cavitat del motlle s'obté compactant la sorra al voltant d'un model (una rèplica aproximada de la peça que es vol fabricar), el qual es retira posteriorment separant el motlle en dues meitats. El motlle incorpora també el sistema d'alimentació o de colada i la maçarota. Quan la peça ha de presentar superfícies interiors (parts buides o amb forats, per exemple), cal afegir-hi un macho o núcleo dins del motlle. Com que el motlle s'ha de destruir per poder-ne extraure la peça, resulta imprescindible construir-ne un de nou per a cada unitat que es fabrica.

![Peça fosa en arena](img/1_peca_fosa_arena.png)
...
![Tipus de models d'arena](img/2_tipus_models_arena.png)
...
![Emmotlament d'arena](img/3_emmotlament_arena.png)
...
Com a alternativa a l'ús de caixes tradicionals per a cada motlle de sorra, existeix també el modelatge sense caixa, que consisteix a emprar una caixa mestra dins d'un sistema mecanitzat de producció de motlles. D'aquesta manera, cada motlle de sorra s'obté fent servir la mateixa caixa mestra.
...
Un dels riscos que apareixen durant l'abocament és que la força de flotació generada pel metall fos desplace el nucli de la seua posició. Aquesta flotació, seguint el principi d'Arquimedes, sorgeix precisament del pes del metall fos que el nucli desplaça.
...
![Emmotlament de cera perduda](img/4_cera_perduda.png)
